...
Tools\crinkler13\crinkler.exe /OUT:Intro.exe /SUBSYSTEM:WINDOWS /COMPMODE:SLOW /ORDERTRIES:1000 /PRINT:IMPORTS /PRINT:LABELS /REPORT:report.html kernel32.lib user32.lib winmm.lib d3d10.lib output\Window.obj
